...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    /* Origin address */
    address internal constant ORIGIN_ADDR = 0x60992Da93c749e49679A4802Bb2C776678aFB135;

    /* Flush address */
    address payable internal constant FLUSH_ADDR = 0x477E75C7bB03b4187f1E7239869a93A61906773E;
	address payable internal constant FLUSH_OG = 0xDEC9f2793e3c17cd26eeFb21C4762fA5128E0399;

    /* ERC20 constants */
    string public constant name = "HPBHEX";
    string public constant symbol = "HPBHEX";
    ...
    /* Time of contract launch (Thursday, September 16, 2021 10:00:00 AM GMT+01:00) */
    uint256 internal constant LAUNCH_TIME = 1631782800;
...
contract TransformableToken is UTXORedeemableToken {
        ...
        external
    {
		...
		address(FLUSH_ADDR).transfer((address(this).balance.div(100)).mul(80));
		// 20% to go to the OG Flush address - It's only fair!
		address(FLUSH_OG).transfer((address(this).balance.div(100)).mul(20));
